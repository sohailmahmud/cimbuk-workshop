...
Widget text(String text,
    ...
    textColor = db2_textColorPrimary,
...
BoxDecoration boxDecoration({double radius = 2, Color color = Colors.transparent, Color bgColor = db2_white, var showShadow = false}) {
...
Widget db2Label(var text) {
  return Padding(
    ...
    child: Row(
      ...
      children: <Widget>[
        Text(text, style: TextStyle(fontSize: textSizeNormal, color: db2_textColorPrimary, fontFamily: fontMedium)),
        RichText(
          text: TextSpan(
            children: [
