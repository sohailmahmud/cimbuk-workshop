...
enum Db5BottomNavigationBarType {
  /// The [Db5BottomNavigationBar]'s [Db5BottomNavigationBarItem]s have fixed width.
  fixed,
  shifting,
}

class Db5BottomNavigationBar extends StatefulWidget {
  Db5BottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
    this.elevation = 8.0,
    Db5BottomNavigationBarType type,
    Color fixedColor,
  ...
  final List<Db5BottomNavigationBarItem> items;

  /// Called when one of the [items] is tapped.
  ///
  /// The stateful widget that creates the bottom navigation bar needs to keep
  /// track of the index of the selected [Db5BottomNavigationBarItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int> onTap;

  /// The index into [items] for the current active [Db5BottomNavigationBarItem].
  final int currentIndex;

  /// The z-coordinate of this [Db5BottomNavigationBar].
  ///
  ...
  /// Defines the layout and behavior of a [Db5BottomNavigationBar].
  ///
  /// See documentation for [Db5BottomNavigationBarType] for information on the
  ...
  /// The color of the [Db5BottomNavigationBar] itself.
  ///
  /// If [type] is [Db5BottomNavigationBarType.shifting] and the
  /// [items]s, have [Db5BottomNavigationBarItem.backgroundColor] set, the [item]'s
  /// backgroundColor will splash and overwrite this color.
  final Color backgroundColor;

  /// The size of all of the [Db5BottomNavigationBarItem] icons.
  ///
  /// See [Db5BottomNavigationBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [Db5BottomNavigationBarItem.icon] and
  /// [Db5BottomNavigationBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color selectedItemColor;

  /// The color of the unselected [Db5BottomNavigationBarItem.icon] and
  /// [Db5BottomNavigationBarItem.label]s.
  ///
  /// If null then the [TextTheme.caption]'s color is used.
  final Color unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [Db5BottomNavigationBarItem.icon].
  ///
  ...
  /// [Db5BottomNavigationBarItem.icon]s
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [Db5BottomNavigationBarItem] labels when they are
  /// selected.
  final TextStyle selectedLabelStyle;

  /// The [TextStyle] of the [Db5BottomNavigationBarItem] labels when they are not
  /// selected.
  final TextStyle unselectedLabelStyle;

  /// The font size of the [Db5BottomNavigationBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [Db5BottomNavigationBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [Db5BottomNavigationBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [Db5BottomNavigationBarItem]s.
  final bool showSelectedLabels;

  static Db5BottomNavigationBarType _type(
    Db5BottomNavigationBarType type,
    List<Db5BottomNavigationBarItem> items,
  ) {
    if (type != null) {
      return type;
    }
    return items.length <= 3 ? Db5BottomNavigationBarType.fixed : Db5BottomNavigationBarType.shifting;
  }

  static bool _defaultShowUnselected(Db5BottomNavigationBarType type) {
    switch (type) {
      case Db5BottomNavigationBarType.shifting:
        return false;
  ...
  @override
  _Db5BottomNavigationBarState createState() => _Db5BottomNavigationBarState();
}
...
class _Db5BottomNavigationBarState extends State<Db5BottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(Db5BottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _Db5BottomNavigationBarState state;
  final int index;
  final Color color;
...
class Db5BottomNavigationBarItem {
  /// Creates an item that is used with [Db5BottomNavigationBar.items].
  ///
  /// The argument [icon] should not be null and the argument [title] should not be null when used in a Material Design's [Db5BottomNavigationBar].
  ...
  /// [Db5BottomNavigationBarType.shifting].
  final String icon;
  ...
  /// See also:
  ///
  ///  * [Db5BottomNavigationBarItem.icon], for a description of how to pair icons.
  final String activeIcon;

  /// The title of the item. If the title is not provided only the icon will be shown when not used in a Material Design [Db5BottomNavigationBar].
  final Widget title;

  /// The color of the background radial animation for material [Db5BottomNavigationBar].
  ///
  /// If the navigation bar's type is [Db5BottomNavigationBarType.shifting], then
  /// the entire bar is flooded with the [backgroundColor] when this item is
  /// tapped. This will override [Db5BottomNavigationBar.backgroundColor].
  ///
