...
enum Db7BottomNavigationBarType {
  /// The [Db7BottomNavigationBar]'s [Db7BottomNavigationBarItem]s have fixed width.
  fixed,
  shifting,
}
...
class Db7BottomNavigationBar extends StatefulWidget {
  Db7BottomNavigationBar({
    ...
    this.currentIndex = 0,
    this.elevation = 8.0,
    Db7BottomNavigationBarType type,
    Color fixedColor,
  ...
  /// track of the index of the selected [Db7BottomNavigationBarItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int> onTap;

  /// The index into [items] for the current active [Db7BottomNavigationBarItem].
  final int currentIndex;

  /// The z-coordinate of this [Db7BottomNavigationBar].
  ///
  ...
  /// Defines the layout and behavior of a [Db7BottomNavigationBar].
  ///
  /// See documentation for [Db7BottomNavigationBarType] for information on the
  ...
  /// The color of the [Db7BottomNavigationBar] itself.
  ///
  /// If [type] is [Db7BottomNavigationBarType.shifting] and the
  /// [items]s, have [Db7BottomNavigationBarItem.backgroundColor] set, the [item]'s
  /// backgroundColor will splash and overwrite this color.
  final Color backgroundColor;

  /// The size of all of the [Db7BottomNavigationBarItem] icons.
  ///
  /// See [Db7BottomNavigationBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [Db7BottomNavigationBarItem.icon] and
  /// [Db7BottomNavigationBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color selectedItemColor;

  /// The color of the unselected [Db7BottomNavigationBarItem.icon] and
  /// [Db7BottomNavigationBarItem.label]s.
  ///
  /// If null then the [TextTheme.caption]'s color is used.
  final Color unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [Db7BottomNavigationBarItem.icon].
  ///
  ...
  /// [Db7BottomNavigationBarItem.icon]s
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [Db7BottomNavigationBarItem] labels when they are
  /// selected.
  final TextStyle selectedLabelStyle;

  /// The [TextStyle] of the [Db7BottomNavigationBarItem] labels when they are not
  /// selected.
  final TextStyle unselectedLabelStyle;

  /// The font size of the [Db7BottomNavigationBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [Db7BottomNavigationBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [Db7BottomNavigationBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [Db7BottomNavigationBarItem]s.
  final bool showSelectedLabels;

  static Db7BottomNavigationBarType _type(
    Db7BottomNavigationBarType type,
    List<Db7BottomNavigationBarItem> items,
  ) {
    if (type != null) {
      return type;
    }
    return items.length <= 3 ? Db7BottomNavigationBarType.fixed : Db7BottomNavigationBarType.shifting;
  }

  static bool _defaultShowUnselected(Db7BottomNavigationBarType type) {
    switch (type) {
      case Db7BottomNavigationBarType.shifting:
        return false;
  ...
  @override
  _Db7BottomNavigationBarState createState() => _Db7BottomNavigationBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final Db7BottomNavigationBarType type;
  final Db7BottomNavigationBarItem item;
...
class _Db7BottomNavigationBarState extends State<Db7BottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(Db7BottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _Db7BottomNavigationBarState state;
  final int index;
  final Color color;
...
class Db7BottomNavigationBarItem {
  /// Creates an item that is used with [Db7BottomNavigationBar.items].
  ///
  ...
  /// [Db7BottomNavigationBarType.shifting].
  final String icon;
  ...
  /// See also:
  ///
  ///  * [Db7BottomNavigationBarItem.icon], for a description of how to pair icons.
  final String activeIcon;

  /// The title of the item. If the title is not provided only the icon will be shown when not used in a Material Design [Db7BottomNavigationBar].
  final Widget title;

  /// The color of the background radial animation for material [Db7BottomNavigationBar].
  ///
  /// If the navigation bar's type is [Db7BottomNavigationBarType.shifting], then
  /// the entire bar is flooded with the [backgroundColor] when this item is
  /// tapped. This will override [Db7BottomNavigationBar.backgroundColor].
  ///
