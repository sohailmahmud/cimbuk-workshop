...
class MovieDetail2ScreenState extends State<MovieDetail2Screen> {
  ...
  Widget build(BuildContext context) {
    var buttons = Row(
      ...
      children: <Widget>[
        Expanded(
            child: iconButton(context, keyString(context, "play"), ic_play_outlined, () {
        ...
        Expanded(
            child: iconButton(context, keyString(context, "my_list"), ic_add, () {},
              ...
              return <Widget>[
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background: Stack(
                      children: <Widget>[
                        networkImage("images/muvi/items/poster_ek42.png", aWidth: width, aHeight: width * (16 / 11), fit: BoxFit.cover),
                        Container(
                          child: Column(
                            children: <Widget>[
