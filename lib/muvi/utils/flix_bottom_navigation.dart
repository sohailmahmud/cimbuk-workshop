...
enum AppBottomNavigationBarType {
  /// The [AppBottomNavigationBar]'s [AppBottomNavigationBarItem]s have fixed width.
  fixed,

  /// The location and size of the [AppBottomNavigationBar] [AppBottomNavigationBarItem]s
...
class AppBottomNavigationBar extends StatefulWidget {
  AppBottomNavigationBar({
    ...
    bool showUnselectedLabels,
        ...
        /*assert(
        items.every((AppBottomNavigationBarItem item) => item.title != null) == true,
  ...
  /// track of the index of the selected [AppBottomNavigationBarItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int> onTap;

  /// The index into [items] for the current active [AppBottomNavigationBarItem].
  final int currentIndex;

  /// The z-coordinate of this [AppBottomNavigationBar].
  ///
  ...
  /// Defines the layout and behavior of a [AppBottomNavigationBar].
  ///
  /// See documentation for [AppBottomNavigationBarType] for information on the
  ...
  /// The color of the [AppBottomNavigationBar] itself.
  ///
  /// If [type] is [AppBottomNavigationBarType.shifting] and the
  /// [items]s, have [AppBottomNavigationBarItem.backgroundColor] set, the [item]'s
  /// backgroundColor will splash and overwrite this color.
  final Color backgroundColor;

  /// The size of all of the [AppBottomNavigationBarItem] icons.
  ///
  /// See [AppBottomNavigationBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [AppBottomNavigationBarItem.icon] and
  /// [AppBottomNavigationBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color selectedItemColor;

  /// The color of the unselected [AppBottomNavigationBarItem.icon] and
  /// [AppBottomNavigationBarItem.label]s.
  ///
  ...
  /// [AppBottomNavigationBarItem.icon]s
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [AppBottomNavigationBarItem] labels when they are
  /// selected.
  final TextStyle selectedLabelStyle;

  /// The [TextStyle] of the [AppBottomNavigationBarItem] labels when they are not
  /// selected.
  final TextStyle unselectedLabelStyle;

  /// The font size of the [AppBottomNavigationBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [AppBottomNavigationBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [AppBottomNavigationBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [AppBottomNavigationBarItem]s.
  final bool showSelectedLabels;

  // Used by the [AppBottomNavigationBar] constructor to set the [type] parameter.
  //
  // If type is provided, it is returned. Otherwise,
  // [AppBottomNavigationBarType.fixed] is used for 3 or fewer items, and
  // [AppBottomNavigationBarType.shifting] is used for 4+ items.
  static AppBottomNavigationBarType _type(
    ...
    return items.length <= 3 ? AppBottomNavigationBarType.fixed : AppBottomNavigationBarType.shifting;
  }

  // Used by the [AppBottomNavigationBar] constructor to set the [showUnselected]
  // parameter.
  //
  // Unselected labels are shown by default for [AppBottomNavigationBarType.fixed],
  // and hidden by default for [AppBottomNavigationBarType.shifting].
  static bool _defaultShowUnselected(AppBottomNavigationBarType type) {
    switch (type) {
      case AppBottomNavigationBarType.shifting:
        return false;
...
class _Circle {
  ...
  final _AppBottomNavigationBarState state;
  final int index;
  final Color color;
...
class AppBottomNavigationBarItem {
  /// Creates an item that is used with [AppBottomNavigationBar.items].
  ///
  /// The argument [icon] should not be null and the argument [title] should not be null when used in a Material Design's [AppBottomNavigationBar].
  ...
  /// [AppBottomNavigationBarType.shifting].
  final String icon;
  ...
  /// See also:
  ///
  ///  * [AppBottomNavigationBarItem.icon], for a description of how to pair icons.
  final String activeIcon;

  /// The title of the item. If the title is not provided only the icon will be shown when not used in a Material Design [AppBottomNavigationBar].
  final Widget title;

  /// The color of the background radial animation for material [AppBottomNavigationBar].
  ///
  /// If the navigation bar's type is [AppBottomNavigationBarType.shifting], then
  /// the entire bar is flooded with the [backgroundColor] when this item is
  /// tapped. This will override [AppBottomNavigationBar.backgroundColor].
  ///
