...
List<HomeSlider> getSliders() {
  ...
  list.add(HomeSlider(
      slideImage: "images/muvi/items/element___image___square_copy_ek1.jpg",
      isHD: true));
  list.add(HomeSlider(
      slideImage: "images/muvi/items/element___image___square_copy_ek3.jpg",
      isHD: false));
  return list;
}
...
List<Movie> getHorizontalMovie() {
  var list = List<Movie>();
  list.add(
      Movie(slideImage: "images/muvi/items/rectangle_ek9.jpg", isHD: true));
  list.add(
      Movie(slideImage: "images/muvi/items/rectangle_ek11.jpg", isHD: false));
  list.add(
      Movie(slideImage: "images/muvi/items/rectangle_ek13.jpg", isHD: true));
  list.add(
      Movie(slideImage: "images/muvi/items/rectangle_ek24.jpg", isHD: false));
  list.add(
      Movie(slideImage: "images/muvi/items/rectangle_ek26.jpg", isHD: false));
...
List<Movie> getContinueMovies() {
  var list = List<Movie>();
  list.add(Movie(
      slideImage: "images/muvi/items/thumbnail_ek1.jpg",
      isHD: true,
      percent: 0.2,
      title: "Joker"));
  list.add(Movie(
      slideImage: "images/muvi/items/thumbnail_ek7.jpg",
      isHD: false,
      percent: 0.8,
  ...
  list.add(Movie(
      slideImage: "images/muvi/items/thumbnail_ek11.jpg",
      isHD: false,
      percent: 0.5,
      title: "Itaewon Class"));
  list.add(Movie(
      slideImage: "images/muvi/items/thumbnail_ek17.jpg",
      isHD: false,
      percent: 0.1,
      title: "The Cars"));
  list.add(Movie(
      slideImage: "images/muvi/items/thumbnail_ek21.jpg",
      isHD: false,
      percent: 0.9,
      title: "Coco"));
...
List<Movie> getDownloadedMovies() {
  var list = List<Movie>();
  list.add(Movie(
      slideImage: "images/muvi/items/thumbnail_ek23.jpg",
      isHD: false,
      percent: 0.5,
      title: "Frozen 2"));
  list.add(Movie(
      slideImage: "images/muvi/items/thumbnail_ek25.jpg",
      isHD: true,
      percent: 0.4,
      title: "Ip Man 4"));
  list.add(Movie(
      slideImage: "images/muvi/items/thumbnail_ek27.jpg",
      isHD: false,
      percent: 0.9,
      title: "Man of Steel"));
...
List<Movie> getActors() {
  var list = List<Movie>();
  list.add(Movie(
      slideImage: "$BaseUrl/images/muvi/items/t3_ic_profile1.png",
      isHD: true,
      percent: 0.2,
      title: "Rajiv Kapoor"));
  list.add(Movie(
      slideImage: "$BaseUrl/images/muvi/items/t3_ic_profile2.png",
      isHD: false,
      percent: 0.8,
      title: "John doe"));
  list.add(Movie(
      slideImage: "$BaseUrl/images/muvi/items/t3_ic_profile3.png",
      isHD: true,
      percent: 0.4,
      title: "Alice Denial"));
  list.add(Movie(
      slideImage: "$BaseUrl/images/muvi/items/t3_ic_profile5.png",
      isHD: false,
      percent: 0.5,
      title: "John Vinaas"));
  list.add(Movie(
      slideImage: "$BaseUrl/images/muvi/items/t3_ic_profile6.png",
      isHD: false,
      percent: 0.1,
      title: "Alexender Cinah"));
  list.add(Movie(
      slideImage: "$BaseUrl/images/muvi/items/t3_ic_profile7.png",
      isHD: false,
      percent: 0.9,
      title: "Tim Svages"));
