...
class T6CarouselSlider extends StatefulWidget {
  T6CarouselSlider(
      {@required this.items,
      this.height,
  ...
  /// The initial page to show when first creating the [T6CarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [T6CarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [T6CarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [T6CarouselSlider].
  ///
  ...
  /// Animates the controlled [T6CarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _T6CarouselSliderState createState() => _T6CarouselSliderState();
}

class _T6CarouselSliderState extends State<T6CarouselSlider> with TickerProviderStateMixin {
  Timer timer;
