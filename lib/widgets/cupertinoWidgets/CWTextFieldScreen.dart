        ...
        child: Column(
          ...
          children: [
            ...
            CupertinoTextField(
              ...
              border: Border.all(width: 1,color: Theme.of(context).dividerColor),borderRadius: BorderRadius.all(Radius.circular(5))),
            ...
            CupertinoTextField(
              ...
              suffix: Icon(isVisible ? Icons.visibility_off : Icons.visibility,color: appStore.iconColor,).paddingOnly(left: 4, right: 8).onTap(() {
                isVisible = !isVisible;
                setState(() {});
              }),
              padding: EdgeInsets.all(12),
            ...
            CupertinoTextField(
              ...
              style: TextStyle(color: white.withOpacity(0.5)),
              cursorColor: white,
              decoration: BoxDecoration(color: getColorFromHex('#8998FF'),),
              padding: EdgeInsets.all(12),
            ),
            12.height,
