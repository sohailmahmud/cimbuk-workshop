...
enum T4BottomNavigationBarType {
  /// The [T4BottomNavigationBar]'s [T4BottomNavigationBarItem]s have fixed width.
  fixed,

  /// The location and size of the [T4BottomNavigationBar] [T4BottomNavigationBarItem]s
  /// animate and labels fade in when they are tapped.
  shifting,
}

class T4BottomNavigationBar extends StatefulWidget {
  T4BottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
    this.elevation = 8.0,
    T4BottomNavigationBarType type,
    Color fixedColor,
  ...
  final List<T4BottomNavigationBarItem> items;

  /// Called when one of the [items] is tapped.
  ///
  /// The stateful widget that creates the bottom navigation bar needs to keep
  /// track of the index of the selected [T4BottomNavigationBarItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int> onTap;

  /// The index into [items] for the current active [T4BottomNavigationBarItem].
  final int currentIndex;

  /// The z-coordinate of this [T4BottomNavigationBar].
  ///
  ...
  /// Defines the layout and behavior of a [T4BottomNavigationBar].
  ///
  /// See documentation for [T4BottomNavigationBarType] for information on the
  /// meaning of different types.
  final T4BottomNavigationBarType type;
  ...
  /// The color of the [T4BottomNavigationBar] itself.
  ///
  /// If [type] is [T4BottomNavigationBarType.shifting] and the
  /// [items]s, have [T4BottomNavigationBarItem.backgroundColor] set, the [item]'s
  /// backgroundColor will splash and overwrite this color.
  final Color backgroundColor;

  /// The size of all of the [T4BottomNavigationBarItem] icons.
  ///
  /// See [T4BottomNavigationBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [T4BottomNavigationBarItem.icon] and
  /// [T4BottomNavigationBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color selectedItemColor;

  /// The color of the unselected [T4BottomNavigationBarItem.icon] and
  /// [T4BottomNavigationBarItem.label]s.
  ///
  /// If null then the [TextTheme.caption]'s color is used.
  final Color unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [T4BottomNavigationBarItem.icon].
  ///
  ...
  /// [T4BottomNavigationBarItem.icon]s
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [T4BottomNavigationBarItem] labels when they are
  /// selected.
  final TextStyle selectedLabelStyle;

  /// The [TextStyle] of the [T4BottomNavigationBarItem] labels when they are not
  /// selected.
  final TextStyle unselectedLabelStyle;

  /// The font size of the [T4BottomNavigationBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [T4BottomNavigationBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [T4BottomNavigationBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [T4BottomNavigationBarItem]s.
  ...
  static T4BottomNavigationBarType _type(
    T4BottomNavigationBarType type,
    List<T4BottomNavigationBarItem> items,
  ) {
    if (type != null) {
      return type;
    }
    return items.length <= 3 ? T4BottomNavigationBarType.fixed : T4BottomNavigationBarType.shifting;
  }
  ...
  static bool _defaultShowUnselected(T4BottomNavigationBarType type) {
    switch (type) {
      case T4BottomNavigationBarType.shifting:
        return false;
  ...
  @override
  _T4BottomNavigationBarState createState() => _T4BottomNavigationBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final T4BottomNavigationBarType type;
  final T4BottomNavigationBarItem item;
...
class _T4BottomNavigationBarState extends State<T4BottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(T4BottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _T4BottomNavigationBarState state;
  final int index;
  final Color color;
...
class T4BottomNavigationBarItem {
  /// Creates an item that is used with [T4BottomNavigationBar.items].
  ///
  /// The argument [icon] should not be null and the argument [title] should not be null when used in a Material Design's [T4BottomNavigationBar].
  const T4BottomNavigationBarItem({
    @required this.icon,
    this.title,
    Widget activeIcon,
    this.backgroundColor,
  ...
  /// [T4BottomNavigationBarType.shifting].
  final String icon;
  ...
  /// See also:
  ///
  ///  * [T4BottomNavigationBarItem.icon], for a description of how to pair icons.
  final String activeIcon;

  /// The title of the item. If the title is not provided only the icon will be shown when not used in a Material Design [T4BottomNavigationBar].
  final Widget title;

  /// The color of the background radial animation for material [T4BottomNavigationBar].
  ///
  /// If the navigation bar's type is [T4BottomNavigationBarType.shifting], then
  /// the entire bar is flooded with the [backgroundColor] when this item is
  /// tapped. This will override [T4BottomNavigationBar.backgroundColor].
  ///
