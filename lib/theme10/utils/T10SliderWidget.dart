...
class T10CarouselSlider extends StatefulWidget {
  T10CarouselSlider(
      {@required this.items,
      this.height,
  ...
  /// The initial page to show when first creating the [T10CarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [T10CarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [T10CarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [T10CarouselSlider].
  ///
  ...
  /// Animates the controlled [T10CarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _T10CarouselSliderState createState() => _T10CarouselSliderState();
}

class _T10CarouselSliderState extends State<T10CarouselSlider> with TickerProviderStateMixin {
  Timer timer;
