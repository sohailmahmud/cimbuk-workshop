...
enum T7BottomNavigationBarType {
  /// The [T7BottomNavigationBar]'s [T7BottomNavigationBarItem]s have fixed width.
  fixed,
  shifting,
}

class T7BottomNavigationBar extends StatefulWidget {
  T7BottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
    this.elevation = 8.0,
    T7BottomNavigationBarType type,
    Color fixedColor,
  ...
  final List<T7BottomNavigationBarItem> items;

  /// Called when one of the [items] is tapped.
  ///
  /// The stateful widget that creates the bottom navigation bar needs to keep
  /// track of the index of the selected [T7BottomNavigationBarItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int> onTap;

  /// The index into [items] for the current active [T7BottomNavigationBarItem].
  final int currentIndex;

  /// The z-coordinate of this [T7BottomNavigationBar].
  ///
  ...
  /// Defines the layout and behavior of a [T7BottomNavigationBar].
  ///
  /// See documentation for [T7BottomNavigationBarType] for information on the
  /// meaning of different types.
  final T7BottomNavigationBarType type;
  ...
  /// The color of the [T7BottomNavigationBar] itself.
  ///
  /// If [type] is [T7BottomNavigationBarType.shifting] and the
  /// [items]s, have [T7BottomNavigationBarItem.backgroundColor] set, the [item]'s
  /// backgroundColor will splash and overwrite this color.
  final Color backgroundColor;

  /// The size of all of the [T7BottomNavigationBarItem] icons.
  ///
  /// See [T7BottomNavigationBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [T7BottomNavigationBarItem.icon] and
  /// [T7BottomNavigationBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color selectedItemColor;

  /// The color of the unselected [T7BottomNavigationBarItem.icon] and
  /// [T7BottomNavigationBarItem.label]s.
  ///
  /// If null then the [TextTheme.caption]'s color is used.
  final Color unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [T7BottomNavigationBarItem.icon].
  ///
  ...
  /// [T7BottomNavigationBarItem.icon]s
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [T7BottomNavigationBarItem] labels when they are
  /// selected.
  final TextStyle selectedLabelStyle;

  /// The [TextStyle] of the [T7BottomNavigationBarItem] labels when they are not
  /// selected.
  final TextStyle unselectedLabelStyle;

  /// The font size of the [T7BottomNavigationBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [T7BottomNavigationBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [T7BottomNavigationBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [T7BottomNavigationBarItem]s.
  final bool showSelectedLabels;

  static T7BottomNavigationBarType _type(
    T7BottomNavigationBarType type,
    List<T7BottomNavigationBarItem> items,
  ) {
    if (type != null) {
      return type;
    }
    return items.length <= 3 ? T7BottomNavigationBarType.fixed : T7BottomNavigationBarType.shifting;
  }

  static bool _defaultShowUnselected(T7BottomNavigationBarType type) {
    switch (type) {
      case T7BottomNavigationBarType.shifting:
        return false;
      case T7BottomNavigationBarType.fixed:
        return true;
    }
    assert(false);
    return false;
  ...
  @override
  _T7BottomNavigationBarState createState() => _T7BottomNavigationBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final T7BottomNavigationBarType type;
  final T7BottomNavigationBarItem item;
...
class _T7BottomNavigationBarState extends State<T7BottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(T7BottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _T7BottomNavigationBarState state;
  final int index;
  final Color color;
...
class T7BottomNavigationBarItem {
  /// Creates an item that is used with [T7BottomNavigationBar.items].
  ///
  /// The argument [icon] should not be null and the argument [title] should not be null when used in a Material Design's [T7BottomNavigationBar].
  const T7BottomNavigationBarItem({
    @required this.icon,
    this.title,
    Widget activeIcon,
    this.backgroundColor,
  ...
  /// [T7BottomNavigationBarType.shifting].
  final String icon;
  ...
  /// See also:
  ///
  ///  * [T7BottomNavigationBarItem.icon], for a description of how to pair icons.
  final String activeIcon;

  /// The title of the item. If the title is not provided only the icon will be shown when not used in a Material Design [T7BottomNavigationBar].
  final Widget title;

  /// The color of the background radial animation for material [T7BottomNavigationBar].
  ///
  /// If the navigation bar's type is [T7BottomNavigationBarType.shifting], then
  /// the entire bar is flooded with the [backgroundColor] when this item is
  /// tapped. This will override [T7BottomNavigationBar.backgroundColor].
  ///
