                  ...
                  Column(
                    children: <Widget>[
                      Padding(
                        ...
                        child: Image(
                          image:
                              AssetImage('images/smartDeck/images/sduser.png'),
                  ...
                  Column(
                    children: <Widget>[
                      Padding(
                        ...
                        child: Image(
                          image: AssetImage(
                              'images/smartDeck/images/sdreport.png'),
                          height: size.height * 0.3,
                          width: size.width,
                          fit: BoxFit.contain,
                        ),
                  ...
                  Column(
                    children: <Widget>[
                      Padding(
                        ...
                        child: Image(
                          image:
                              AssetImage('images/smartDeck/images/sdclip.png'),
                          height: size.height * 0.3,
                          width: size.width,
                          fit: BoxFit.contain,
                        ),
                      ...
                      Padding(
                        ...
                        child: Text(
                            'You can easy to customize your \ncontent match with your interest',
