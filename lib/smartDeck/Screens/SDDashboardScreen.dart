...
List<LessonsModel> lessons = [
  ...
  LessonsModel(image: 'images/smartDeck/images/sdmusic.png', title: 'Music', backgroundImages: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSePqEkOx6meh5aP5W0wRjvqCwDMFrpKyjFQA&usqp=CAU'),
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SDExamScreen(cards[index].examName, cards[index].image, cards[index].startColor, cards[index].endColor),
                        ),
                      );
                    },
                    child: Container(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              Text(
                                cards[index].time,
                                style: secondaryTextStyle(textColor: Colors.white54, size: 18),
                              ),
                              cards[index].icon
                            ],
                          )
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SdViewAllLiveVideoScreen(),
                      ),
                    );
                  },
                  child: Text(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: secondaryTextStyle(size: 8, textColor: Colors.white),
                                  ),
                                ),
                              ),
                            )
