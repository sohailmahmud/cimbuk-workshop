        ...
        child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: () {
                    callNext(GroceryHomeDelivery(), context);
                  },
                  child: Row(
                    children: <Widget>[
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                text(grocery_lbl_Home_Delivery, fontSize: textSizeLargeMedium, fontFamily: fontMedium).paddingOnly(
                                  left: spacing_standard,
                                  right: spacing_standard,
                                ),
                                text(
                                  "Within delivery grid",
                ...
                GestureDetector(
                  onTap: () {
                    callNext(GroceryPickupFromOutlet(), context);
                  },
                  child: Row(
                    children: <Widget>[
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                text(grocery_lbl_PickUp, fontSize: textSizeLargeMedium, fontFamily: fontMedium).paddingOnly(
                                  left: spacing_standard,
                                  right: spacing_standard,
                                ),
                                text(
