...
enum T9BottomNavigationBarType {
  /// The [T9BottomNavigationBar]'s [T9BottomNavigationBarItem]s have fixed width.
  fixed,

  /// The location and size of the [T4BottomNavigationBar] [T9BottomNavigationBarItem]s
  /// animate and labels fade in when they are tapped.
  shifting,
}

class T9BottomNavigationBar extends StatefulWidget {
  T9BottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
    this.elevation = 8.0,
    T9BottomNavigationBarType type,
    Color fixedColor,
  ...
  final List<T9BottomNavigationBarItem> items;

  /// Called when one of the [items] is tapped.
  ///
  /// The stateful widget that creates the bottom navigation bar needs to keep
  /// track of the index of the selected [T9BottomNavigationBarItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int> onTap;

  /// The index into [items] for the current active [T9BottomNavigationBarItem].
  final int currentIndex;

  /// The z-coordinate of this [T9BottomNavigationBar].
  ///
  ...
  /// Defines the layout and behavior of a [T9BottomNavigationBar].
  ///
  /// See documentation for [T9BottomNavigationBarType] for information on the
  /// meaning of different types.
  final T9BottomNavigationBarType type;
  ...
  /// The color of the [T9BottomNavigationBar] itself.
  ///
  /// If [type] is [T9BottomNavigationBarType.shifting] and the
  /// [items]s, have [T9BottomNavigationBarItem.backgroundColor] set, the [item]'s
  /// backgroundColor will splash and overwrite this color.
  final Color backgroundColor;

  /// The size of all of the [T9BottomNavigationBarItem] icons.
  ///
  /// See [T9BottomNavigationBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [T9BottomNavigationBarItem.icon] and
  /// [T9BottomNavigationBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color selectedItemColor;

  /// The color of the unselected [T9BottomNavigationBarItem.icon] and
  /// [T9BottomNavigationBarItem.label]s.
  ///
  /// If null then the [TextTheme.caption]'s color is used.
  final Color unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [T9BottomNavigationBarItem.icon].
  ///
  ...
  /// [T9BottomNavigationBarItem.icon]s
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [T9BottomNavigationBarItem] labels when they are
  /// selected.
  final TextStyle selectedLabelStyle;

  /// The [TextStyle] of the [T9BottomNavigationBarItem] labels when they are not
  /// selected.
  final TextStyle unselectedLabelStyle;

  /// The font size of the [T9BottomNavigationBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [T9BottomNavigationBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [T9BottomNavigationBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [T9BottomNavigationBarItem]s.
  ...
  static T9BottomNavigationBarType _type(
    T9BottomNavigationBarType type,
    List<T9BottomNavigationBarItem> items,
  ) {
    if (type != null) {
      return type;
    }
    return items.length <= 3 ? T9BottomNavigationBarType.fixed : T9BottomNavigationBarType.shifting;
  }
  ...
  static bool _defaultShowUnselected(T9BottomNavigationBarType type) {
    switch (type) {
      case T9BottomNavigationBarType.shifting:
        return false;
      case T9BottomNavigationBarType.fixed:
        return true;
    }
    assert(false);
    return false;
  ...
  @override
  _T9BottomNavigationBarState createState() => _T9BottomNavigationBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final T9BottomNavigationBarType type;
  final T9BottomNavigationBarItem item;
...
class _T9BottomNavigationBarState extends State<T9BottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(T9BottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _T9BottomNavigationBarState state;
  final int index;
  final Color color;
...
class T9BottomNavigationBarItem {
  /// Creates an item that is used with [T9BottomNavigationBar.items].
  ///
  /// The argument [icon] should not be null and the argument [title] should not be null when used in a Material Design's [T9BottomNavigationBar].
  const T9BottomNavigationBarItem({
    @required this.icon,
    this.title,
    Widget activeIcon,
    this.backgroundColor,
  ...
  /// [T9BottomNavigationBarType.shifting].
  final String icon;
  ...
  /// See also:
  ///
  ///  * [T9BottomNavigationBarItem.icon], for a description of how to pair icons.
  final String activeIcon;

  /// The title of the item. If the title is not provided only the icon will be shown when not used in a Material Design [T9BottomNavigationBar].
  final Widget title;

  /// The color of the background radial animation for material [T9BottomNavigationBar].
  ///
  /// If the navigation bar's type is [T9BottomNavigationBarType.shifting], then
  /// the entire bar is flooded with the [backgroundColor] when this item is
  /// tapped. This will override [T9BottomNavigationBar.backgroundColor].
  ///
