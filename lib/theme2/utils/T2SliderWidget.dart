...
class T2CarouselSlider extends StatefulWidget {
  T2CarouselSlider(
      {@required this.items,
      this.height,
  ...
  /// The initial page to show when first creating the [T2CarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [T2CarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [T2CarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [T2CarouselSlider].
  ///
