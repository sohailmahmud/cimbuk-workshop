...
class T5CarouselSlider extends StatefulWidget {
  T5CarouselSlider(
      {@required this.items,
      this.height,
  ...
  @override
  _T5CarouselSliderState createState() => _T5CarouselSliderState();
}

class _T5CarouselSliderState extends State<T5CarouselSlider> with TickerProviderStateMixin {
  Timer timer;
