      ...
      child: Column(
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: Container(padding: EdgeInsets.all(16), alignment: Alignment.centerRight, child: Icon(Icons.close, color: t5TextColorPrimary)),
          ),
          Container(
            width: 45,
            height: 45,
          ...
          SizedBox(height: 24),
          text(them5_lbl_fingerprint_authentication, textColor: t5TextColorPrimary, fontFamily: fontBold, fontSize: textSizeNormal),
          Padding(
