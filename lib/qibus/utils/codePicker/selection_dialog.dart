...
class _SelectionDialogState extends State<SelectionDialog> {
  ...
  Widget build(BuildContext context) => SimpleDialog(
        title: Column(
          ...
          children: <Widget>[
            text("Select Country Code", textColor: t5TextColorPrimary, fontSize: textSizeNormal, fontFamily: fontSemibold),
            TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(), fontSize: textSizeMedium, textColor: t5TextColorPrimary)),
                text(e.dialCode, fontSize: textSizeMedium, textColor: t5TextColorPrimary, fontFamily: fontSemibold),
              ],
            ),
          ),
        ],
