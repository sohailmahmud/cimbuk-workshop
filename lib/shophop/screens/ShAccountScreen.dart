              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      text(sh_lbl_please_verify_your_email_or_number,
                          textColor: sh_textColorPrimary,
              ...
              child: Column(
                children: <Widget>[
                  getRowItem(sh_lbl_address_manager, callback: () {
                    launchScreen(context, ShAddressManagerScreen.tag);
                  }),
                  SizedBox(
                    height: spacing_standard_new,
                  ),
                  ...
                  getRowItem(sh_lbl_my_offers, callback: () {
                    launchScreen(context, ShOffersScreen.tag);
                  }),
                  SizedBox(
                    height: spacing_standard_new,
                  ),
                  ...
                  getRowItem(sh_lbl_quick_pay_cards, callback: () {
                    launchScreen(context, ShQuickPayCardsScreen.tag);
                  }),
                  SizedBox(
                    height: spacing_standard_new,
                  ),
