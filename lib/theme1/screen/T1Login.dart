          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 16),
                Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[formHeading(t1_lbl_sign_in_header), formSubHeadingForm(t1_lbl_sign_up)]),
                SizedBox(height: 50),
                ...
                SizedBox(height: 24),
                text(t1_lbl_forgot_password, textColor: t1_textColorPrimary, fontFamily: fontMedium)
              ],
            ),
          ),
        ),
