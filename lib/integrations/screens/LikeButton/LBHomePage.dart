        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Container(padding: EdgeInsets.only(left: 10), child: Text('John Doe', style: TextStyle(fontSize: 18))),
              ),
              Container(margin: EdgeInsets.only(right: 10), child: Icon(Icons.more_vert, color: Colors.black))
            ],
          ),
          Container(
