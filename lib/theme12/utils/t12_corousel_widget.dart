...
class T12CarouselSlider extends StatefulWidget {
  ...
  /// The initial page to show when first creating the [T12CarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [T12CarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [T12CarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [T12CarouselSlider].
  ///
  ...
  @override
  _T12CarouselSliderState createState() => _T12CarouselSliderState();
}
