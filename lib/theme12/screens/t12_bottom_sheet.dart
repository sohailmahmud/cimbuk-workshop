          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  text("Desko Electricity",fontFamily: fontMedium).paddingTop(spacing_standard),
                  text("Last Payment Date: 24 May 2020",fontSize: textSizeMedium).paddingTop(spacing_control_half),
                ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  text("Subscriber ID",textColor: t12_text_color_primary),
                  formField(context,"Your Subcriber Id", prefixIcon: Icons.person_outline).paddingTop(spacing_standard),
                  text("Bill No",textColor: t12_text_color_primary).paddingTop(spacing_standard),
                  formField(context,"Enter the bill number", prefixIcon: Icons.device_unknown).paddingTop(spacing_standard),
                  text("Amount",textColor: t12_text_color_primary).paddingTop(spacing_standard),
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: <Widget>[
                                                            Container(
                                                              decoration: boxDecoration(showShadow: true,bgColor: Color(0xffBBd2fc),radius: spacing_standard),
                                                              child: Image.asset("",width: 24,height: 24,).paddingAll(spacing_standard_new),
                                                            ),
                                                            Expanded(
                                                              child: Column(
                                                                children: <Widget>[
