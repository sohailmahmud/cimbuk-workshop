                    ...
                    children: <Widget>[
                      ...
                      Form(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            formField(context, "Your Name",
                                prefixIcon: Icons.person_outline,
                                focusNode: nameFocus,
                                textInputAction: TextInputAction.next,
                                nextFocus: phoneNumberFocus, onSaved: (String value) {
                                  setState(() {
                                    name = value;
                                  });
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(child: text("I agree to the Terms & conditions and Privacy Policy",fontSize: textSizeMedium,maxLine: 2))
                        ],
