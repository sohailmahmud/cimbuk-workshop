        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              decoration:
                  boxDecoration(showShadow: true, radius: spacing_standard),
              child: Stack(
                ...
                children: <Widget>[
                  Container(
                    child: Column(
                      children: <Widget>[
                        ...
                        text("Ui/UX Designer", fontSize: textSizeMedium)
                  ...
                  text("Edit",
                          textColor: t12_primary_color, fontFamily: fontMedium)
                        ...
                        return Column(
                          ...
                          children: <Widget>[
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                text("Bank Name", fontSize: textSizeMedium),
                                text("City Bank",
                                    textColor: t12_text_color_primary,
                                    fontFamily: fontMedium),
                              ],
