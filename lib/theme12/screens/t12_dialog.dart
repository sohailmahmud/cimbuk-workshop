  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        toolBarTitle("Successful").paddingTop(spacing_large),
        text("You have successfully completed you bill pay",maxLine: 5,isCentered: true,fontSize: textSizeMedium).paddingTop(spacing_control),
