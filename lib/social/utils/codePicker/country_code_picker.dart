...
import 'package:prokit_flutter/social/utils/codePicker/selection_dialog.dart';

import '../SocialConstant.dart';
...
//                : Container(),
            Flexible(
              ...
              child: text(selectedItem.toCountryCodeString(),
                  textColor: social_colorPrimary, fontSize: textSizeMedium),
            ),
          ],
        ),
      );
